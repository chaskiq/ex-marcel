...
puts ""
puts "defmodule ExMarcel.Tables do"
puts "  @extensions %{"
...
puts "  def extensions, do: @extensions"
puts "  def type_exts, do: @type_exts"
puts "  def type_parents, do: @type_parents"
puts "  def magic, do: @magic"
puts "end"
